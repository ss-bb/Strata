...
/*
 ...
 ! Note that I didn't write this directive for this test, i used it from an old project ! 

*/


app.directive('transitionView', ['$route', '$anchorScroll', '$compile', '$controller', function ($route, $anchorScroll, $compile, $controller) {
    return {
        restrict: 'A',
        terminal: true,
